...
from app.domain.enums.photo_enum import PhotoCategoryEnum, PhotoVisibilityEnum, PhotoProcessingStatusEnum
...
class PhotoModel(Base):
    ...
    category: Mapped[PhotoCategoryEnum] = mapped_column(Enum(PhotoCategoryEnum, name="photo_category_enum", native_enum=False, values_callable=lambda enum_cls: [e.value for e in enum_cls]), nullable=False)
    visibility: Mapped[PhotoVisibilityEnum] = mapped_column(Enum(PhotoVisibilityEnum, name="photo_visibility_enum", native_enum=False, values_callable=lambda enum_cls: [e.value for e in enum_cls]), nullable=False)
    processing_status: Mapped[PhotoProcessingStatusEnum] = mapped_column(Enum(PhotoProcessingStatusEnum, name="photo_processing_status_enum", native_enum=False, values_callable=lambda enum_cls: [e.value for e in enum_cls]), nullable=False)
