...
from app.domain.constants.property_constants import PROPERTY_DESCRIPTION_MAX_LENGHT, PROPERTY_PUBLIC_ID_SIZE
...
class PropertyModel(Base):
    ...
    photos = relationship("PhotoModel", back_populates="property", cascade="all, delete-orphan", lazy="selectin", primaryjoin="and_(PropertyModel.id == PhotoModel.property_id, PhotoModel.deleted_at.is_(None), PhotoModel.visibility == 'public', PhotoModel.is_active == True, PhotoModel.processing_status == 'ready')", order_by="PhotoModel.position")
    photos_all = relationship("PhotoModel", back_populates="property", cascade="all, delete-orphan", lazy="selectin", primaryjoin="and_(PropertyModel.id == PhotoModel.property_id, PhotoModel.deleted_at.is_(None), PhotoModel.processing_status == 'ready')", order_by="PhotoModel.position", viewonly=True, overlaps="photos")
