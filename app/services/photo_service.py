...
from app.core.exceptions.domain_exception import PhotoNotFound, InvalidImageType, ImageTooLarge
...
# -----------------------------------------------
    ...
    def generate_presigned_upload_url(
        ...
        storage_key = PhotoService._build_photo_storage_key(property_public_id, photo.public_id, content_type, StorageObjectTypeEnum.ORIGINAL)
        ...
        presigned_data: PresignedUploadUrlData = storage.generate_presigned_upload_url(storage_key=storage_key, content_type=content_type)
...
# -----------------------------------------------
    ...
    def create(
        ...
        db_property = PropertyService.get_by_public_id_or_404(db, property_public_id, is_active=None, include_deleted=False)
...
# -----------------------------------------------
    ...
    @staticmethod
    def _get_by_id_or_404(db: Session, id: int, is_active: bool | None = True, include_deleted: bool = False) -> PhotoModel | None:
    ...
    @staticmethod
    def _get_by_public_id_or_404(db: Session, public_id: str, is_active: bool | None = True, include_deleted: bool = False) -> PhotoModel | None:
...
# -----------------------------------------------
    ...
    @staticmethod
    def _build_photo_storage_key(property_public_id: str, photo_public_id: str, content_type: str, variant: StorageObjectTypeEnum = StorageObjectTypeEnum.ORIGINAL) -> str:
