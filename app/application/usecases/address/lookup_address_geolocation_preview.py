...
class LookupAddressGeolocationPreviewUseCase:
    ...
    async def execute(self, data: AddressGeolocationPreviewInput) -> AddressGeolocationPreviewOutput:
        ...
        return AddressGeolocationPreviewOutput(
            latitude=result.latitude, longitude=result.longitude, confidence=result.confidence, provider=result.provider
        )
