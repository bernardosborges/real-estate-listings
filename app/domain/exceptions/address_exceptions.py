...
class InvalidLatitude(DomainException):
    ...
    def __init__(self, value: str):
        super().__init__(message=f"Invalid latitude: '{value}'.", value=value)
...
class InvalidLongitude(DomainException):
    ...
    def __init__(self, value: str):
        super().__init__(message=f"Invalid longitude: '{value}'.", value=value)
...
class InvalidZipCode(DomainException):
    ...
    def __init__(self, value: str):
        super().__init__(message=f"Invalid zipcode: '{value}'.", value=value)
...
class InvalidAddressField(DomainException):
    ...
    def __init__(self, value: str):
        super().__init__(message=f"Invalid address field: '{value}'.", value=value)
...
class CEPNotFound(DomainException):
    ...
    def __init__(self, cep: str | None = None):
        super().__init__(message=f"CEP '{cep}' was not found", cep=cep)
