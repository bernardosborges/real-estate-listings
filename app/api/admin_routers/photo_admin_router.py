...
from app.api.deps.general_deps import get_db_session, get_superuser
...
def reprocess_photo_endpoint(
    public_id: str, db: Session = Depends(get_db_session), current_user: UserModel = Depends(get_superuser)
):
