        ...
        "json_schema_extra": {
            "example": {
                ...
                "tags": [
                    {
                        "tag_slug": "1-dorm-0-suite",
                        "tag_name": "1 dormitório (sem suite)",
                        "group_slug": "bedrooms",
                        "group_name": "Dormitórios",
                    }
                ],
            }
        },
...
class PropertyTagUpdateSchema(BaseModel):
    ...
    model_config = {
        ...
        "from_attributes": True,
        "json_schema_extra": {"example": {"tags": ["1-dorm-0-suite"]}},
    }
...
class PropertyTagDeleteSchema(BaseModel):
    ...
    model_config = {
        "title": "PropertyTagReadSchema",
        "from_attributes": True,
        "json_schema_extra": {"example": {"property_id": 10, "tags_slug": ["1-dorm-0-suite"]}},
    }
